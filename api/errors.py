...
class MCPToolError(FabricError):
    ...
    def __init__(self, message: str = "MCP tool error", details: dict[str, Any] | None = None):
        super().__init__(
            error_code="invalid_parameter",
            message=message,
            status_code=400,
...
class CapabilityConflictError(FabricError):
    ...
    def __init__(self, message: str = "Capability conflict", details: dict[str, Any] | None = None):
        super().__init__(
...
class SchemaBreakingChangeError(FabricError):
    ...
    def __init__(
        self, message: str = "Schema breaking change", details: dict[str, Any] | None = None
    ):
        super().__init__(
